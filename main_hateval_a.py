...
new_data_path = "/Users/paulafortuna/PycharmProjects/HatEval/original_datasets/public_development_en/test_en.tsv"
...
experiments_to_use = ["extract_LSTMFeatures",
                      "experiment1hateval_en_LSTMFeatures_xgBoost_normalizenone_weightFalse_use_grid_searchTrue_epochs10_batch128"
                      ]
for experiment_id in experiments_to_use:
    classify_new_data = ClassifyNewContestDataAfterExperiment(experiment_id)
    classify_new_data.start_classification(new_data_path, "test_new_data_hateval", True, "id")
